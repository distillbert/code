...
import bertviz.utils as bv_utils
import bertviz.visualize as bv_viz
...
class MnliProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return list(str(x) for x in range(3))
...
def main():
    ...
    if args.do_train:
        ...
        convert = bv_utils.convert_single_to_dp if isinstance(model, torch.nn.DataParallel) else bv_utils.convert_dp_to_single
